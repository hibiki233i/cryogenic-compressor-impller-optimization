...
# 定义变量名称和物理边界
var_names = ['d1s', 'dH', 'beta1hb', 'beta1sb', 'd2', 'b2', 'beta2hb', 'beta2sb', 'Lz', 't', 'TipClear', 'nBl', 'rake_te_s', 'P_out' ]
L_BOUNDS = np.array([0.34, 0.044, 70.0, 20.0, 0.45, 0.044, 40.0, 40.0, 0.185, 0.0015, 0.0007, 9, -25.0, 8.0])
U_BOUNDS = np.array([0.42, 0.056, 84.0, 35.0, 0.53, 0.056, 54.0, 55.0, 0.215, 0.0035, 0.0015, 12, -15.0, 13.0])
